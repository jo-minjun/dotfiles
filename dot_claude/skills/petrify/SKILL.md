...
- **petrify 프로젝트**: `/Users/minjun.jo/Projects/me/petrify`
- **출력 디렉토리**: `/Users/minjun.jo/Documents/Obsidian Vault/Excalidraw`
- **예시 파일**: `/Users/minjun.jo/Projects/me/petrify/examples/`

## 변환 방법

```bash
cd /Users/minjun.jo/Projects/me/petrify && source .venv/bin/activate && python scripts/convert.py <input> <output>
```
...
```bash
# 단일 파일 변환
python scripts/convert.py examples/normal/normal.note "/Users/minjun.jo/Documents/Obsidian Vault/Excalidraw/normal.excalidraw.md"

# 여러 파일 변환 (디렉토리 내 모든 .note 파일)
python scripts/convert.py examples/ "/Users/minjun.jo/Documents/Obsidian Vault/Excalidraw/"
```
